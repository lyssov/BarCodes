package net.iptp.server.Services.Operations;
 ...
 * Date: 20.01.2017
 * Time: 11:25
 * Bar Reader scan PDF files, recognise and decode Barcode in 3of9 or UPC-A formats
 */
...
//    private String[] foundBarCodes;

    public static Logger log= Logger.getLogger("RequestDispatcher");

 /**
* @return The current scan and recognise barcode.
*/
    ...
    public void  DoBarRead (String imageFile, String fileName, Tools tools) {
        try{
/**
* Load PDF document and render to image
 * pdfFile - String full path as "/home/ilysov/PDFs/test.pdf"
*/          BufferedImage[] image;
//            BufferedImage image;
            Filename name = new Filename(fileName, '/', '.');
...
//            ImageIOUtil.writeImage(image, pdfFile  + ".png", 300);   // Write image as PNG file
